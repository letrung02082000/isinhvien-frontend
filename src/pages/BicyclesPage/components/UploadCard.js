...
import { selectUser, updateCard, logoutUser } from '../../../store/userSlice';
  ...
  return (
    <div className={styles.container}>
      <div className={styles.formGroup}>
        ...
        >
          Nếu gặp lỗi khi cập nhật giấy tờ tùy thân, vui lòng đăng xuất tài
          khoản và đăng nhập lại để khắc phục.
          <br />
          Vui lòng cập nhật giấy tờ tùy thân trước khi đến để không phải chờ đợi
          lâu. Xin cảm ơn.
        </p>
        {uploading ? (
